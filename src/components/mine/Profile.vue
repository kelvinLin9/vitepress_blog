<template>
  ...
  <table class="w-full table-fixed border-0 overflow-x-auto">
    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
      <tr>
        <th scope="col" class="w-1/3">Field</th>
        <th scope="col" class="w-2/3">Value</th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
const resetLocaljDocsSettings = settingStore.resetLocaljDocsSettings
